class Euporie < Formula
  ...
  desc "Suite of terminal applications for interacting with Jupyter kernels"
  homepage "https://github.com/joouha/euporie"
  url "https://files.pythonhosted.org/packages/2e/b1/eb5a35d133fb9b3b5838da3bec7c5a207ac48b68ea562824ba8cf6aa050b/euporie-2.10.4.tar.gz"
  ...
  resource "python-code-minimap" do
    url "https://files.pythonhosted.org/packages/b1/06/d545e0e1b9999b54c32e12d11f0bad9f11211580d3b20e4b015d74a2026b/python_code_minimap-0.1.1.tar.gz"
    sha256 "451cb6872ab81721b1a7882e0779f370122527a3463bf29175f962678c3d3025"
  end
  ...
  resource "sixelcrop" do
    url "https://files.pythonhosted.org/packages/1c/3d/c576ad3649bec5259b8cc64a05b4c1fd7d1d1ee44e0b577d2e8891f41783/sixelcrop-0.1.9.tar.gz"
  ...
  resource "universal-pathlib" do
    url "https://files.pythonhosted.org/packages/3d/6e/d997a70ee8f4c61f9a7e2f4f8af721cf072a3326848fc881b05187e52558/universal_pathlib-0.3.10.tar.gz"
    sha256 "4487cbc90730a48cfb64f811d99e14b6faed6d738420cd5f93f59f48e6930bfb"
  end
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/euporie --version")
  end
end

# brew-capture: Formula/euporie.rb
